...
FCFLAGS = -g -O0 -Waliasing -Wampersand -Wcharacter-truncation -Winteger-division -Wsurprising -fimplicit-none -fcheck=all,no-array-temps -fbacktrace -fdefault-real-8
FLIBS   = -llapack -lblas
...
codice:      codice.o MPI_module_mod.o grid_mod.o essential_mod.o compact_mod.o bandedmatrix_mod.o input_mod.o ic_and_bc_mod.o set_pressure_mod.o solve_pressure_mod.o library_mod.o thomas_mod.o SPIKE_mod.o variables_mod.o
codice.o:             MPI_module_mod.o grid_mod.o essential_mod.o compact_mod.o                    input_mod.o ic_and_bc_mod.o set_pressure_mod.o solve_pressure_mod.o                            SPIKE_mod.o variables_mod.o
